...
import { Brain, TrendingUp, AlertTriangle, Plus, ChevronDown, ChevronUp } from 'lucide-react';
...
export function TradingPsychology() {
  ...
  const [selectedEntry, setSelectedEntry] = useState<PsychologyEntry | null>(null);
    ...
    <div className="bg-tv-bg-secondary rounded-lg border border-tv-border">
      <div className="p-4 border-b border-tv-border">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold text-tv-text-primary">Trading Psychology</h2>
          </div>
          <button
      ...
      <div className="p-4 space-y-6">
        ...
        <div>
          ...
          >
            <h3 className="text-lg font-medium text-tv-text-primary">Mood Patterns</h3>
        ...
        <div>
          ...
          >
            <h3 className="text-lg font-medium text-tv-text-primary">Recent Entries</h3>
                  ...
                  {entry.externalFactors.length > 0 && (
                    <div className="mt-2 flex flex-wrap gap-1">
                      {entry.externalFactors.map((factor, index) => (
                        <span
                          key={index}
                          className="px-2 py-0.5 text-xs bg-tv-bg-secondary text-tv-text-secondary rounded-full"
                        >
                          {factor}
                        </span>
                      ))}
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      const input = document.querySelector('input[placeholder="Add a factor"]') as HTMLInputElement;
